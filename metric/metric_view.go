...
// AggregatorFactory supports creating custom aggregators for a given view.
type AggregatorFactory interface {

	// NewInstance returns a new aggregator object.
...
func (v View) AggregatorFactory() AggregatorFactory {
	return v.aggregatorFactory
}

// NewView returns a view object for the given parameters.
func NewView(inst SyncImpl, labelConfig ViewLabelConfig, labelKeys []label.Key, factory AggregatorFactory) View {
	return View{
		inst:              inst,
